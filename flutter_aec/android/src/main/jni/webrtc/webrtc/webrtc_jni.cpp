...
#define JNI_API(retType, funName, ...) extern "C"  JNIEXPORT retType Java_com_neodent_flutter_1aec_WebRtcJni_##funName(JNIEnv* env, jclass cls,__VA_ARGS__)
#define JNI_API1(retType, funName) extern "C"  JNIEXPORT retType Java_com_neodent_flutter_1aec_WebRtcJni_##funName(JNIEnv* env, jclass cls)
